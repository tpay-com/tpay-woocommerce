...
final class TpayCCBlock extends AbstractPaymentMethodType
{
    ...
    {
        $this->settings = get_option('woocommerce_tpaycc_settings', []);
        $this->gateway = new TpayCC();
    }
    ...
    {
        wp_register_script('tpaycc', plugin_dir_url(__DIR__).'../views/assets/checkout-blocks.min.js', [
            'wc-blocks-registry',
            'wc-settings',
            'wp-element',
            'wp-html-entities',
