...
final class TpayInstallmentsBlock extends AbstractPaymentMethodType
{
    ...
    {
        $this->settings = get_option('woocommerce_tpayinstallments_settings', []);
        $this->gateway = new TpayInstallments();
    }
    ...
    {
        wp_register_script('tpayinstallments', plugin_dir_url(__DIR__).'../views/assets/checkout-blocks.min.js', [
            'wc-blocks-registry',
            'wc-settings',
            'wp-element',
            'wp-html-entities',
