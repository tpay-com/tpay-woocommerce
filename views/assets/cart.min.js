...
function createInstallmentsButton() {
  let valueText = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cart-subtotal .woocommerce-Price-amount bdi').contents()[0].data;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('updated_cart_totals', () => {
    createInstallmentsButton();
  });
});
})();
