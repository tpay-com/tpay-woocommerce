...
function addInstallmentsIframe() {
    let url = 'https://secure.tpay.com/Installment/Pekao/page?merchantId=__merchantId__&amount=__amount__';
    url = url.replace('__merchantId__', tpayInstallmentsBlocks.merchantId).replace('__amount__', String(amount));
...
document.addEventListener('DOMContentLoaded', () => {
    registerPlugin('tpay-installments', {
        render,
