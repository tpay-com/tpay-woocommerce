...
- Merchant Email is used for merchant notifications for subscription orders

## [1.15.0]

### Changed

- Redesign & WCAG (accessibility) improvements in checkout related views
...
- Stricter check if extra fee is enabled
- When extra fee is calculated to zero record will not be added
